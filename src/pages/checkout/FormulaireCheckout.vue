    ...
    <form @submit.prevent="soumettreInfos">
      <div>
        ...
        <div class="form-control" :class="{ invalide: !carteCreditValide }">
          ...
          <input
            ...
            name="cartecredit"
            type="text"
            v-model.trim="carteCredit"
          />
          <span v-if="!carteCreditValide"
            >Veuillez entrer un numéro de carte de crédit sous la forme 4555
            5555 5555 5555</span
          >
        </div>
        <div class="form-control" :class="{ invalide: !dateExpValide }">
          ...
          <input
            ...
            name="dateexp"
            type="text"
            v-model.trim="dateExp"
          />
          <span v-if="!dateExpValide"
            >Veuillez entrer une date d'expiration, p.ex. 2024/05</span
          >
        </div>
      </div>
      <h2>Expédition</h2>
      ...
      <div>
        ...
        <div class="form-control" :class="{ invalide: !adresseValide }">
          ...
          <input
            id="adresse-expedition"
            name="adresse-expedition"
            type="text"
        ...
        <div class="form-control" :class="{ invalide: !provinceValide }">
          ...
          <select id="province" name="province" v-model="province">
            <option v-for="province in listeProvinces" :value="province">
              {{ province }}
            </option>
          </select>
        ...
        <div class="form-control" :class="{ invalide: !codePostalValide }">
          ...
          <input
            id="codepostal-expedition"
            name="codepostal-expedition"
            type="text"
            v-model.trim="codePostal"
          />
          <span v-if="!codePostalValide"
            >Veuillez entrer un code postal valide</span
          >
        </div>
      </div>
...
export default {
  ...
  methods: {
    soumettreInfos() {
      ...
      if (
        this.nomPaiementValide &&
        this.carteCreditValide &&
        this.dateExpValide &&
        this.nomExpeditionValide &&
        this.adresseValide &&
        this.villeValide &&
        this.provinceValide &&
        this.codePostalValide
      ) {
